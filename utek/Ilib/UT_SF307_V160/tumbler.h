...
protected:
    ...
    void drawSelectText(QPainter *painter, int offset);
...
Q_SIGNALS:
    void currentIndexChanged(int currentIndex, int oldIndex);
    void currentValueChanged(QString currentValue, QString oldValue);
};
