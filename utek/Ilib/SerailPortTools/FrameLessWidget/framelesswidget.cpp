...
//    QApplication::instance()->installEventFilter(this);
    ui->windowTitlebar->installEventFilter(this);
    ui->windowContent->installEventFilter(this);
...
bool FramelessWidget::eventFilter(QObject *obj, QEvent *event) {
    ...
    } else if(event->type() == QEvent::Leave && obj == this){
        setCursor(Qt::ArrowCursor);
    } else if(event->type() == QEvent::Enter && obj != this){
        setCursor(Qt::ArrowCursor);
    }
