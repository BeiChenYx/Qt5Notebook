...
void ProgressBarPercent::drawValue(QPainter *painter, int radius)
{
    painter->save();
...
int ProgressBarPercent::getBorderWidth() const
{
    return this->borderWidth;
}

double ProgressBarPercent::getWaterHeight() const
{
    return this->waterHeight;
}

double ProgressBarPercent::getWaterDensity() const
{
...
bool ProgressBarPercent::getBorderOut() const
{
...
void ProgressBarPercent::setBorderWidth(int borderWidth)
{
...
void ProgressBarPercent::setWaterHeight(double waterHeight)
{
    if (waterHeight > 0.1) {
        return;
    }
...
void ProgressBarPercent::setWaterDensity(double waterDensity)
{
...
void ProgressBarPercent::setBorderOut(bool borderOut)
{
...
void ProgressBarPercent::setPercentStyle(const ProgressBarPercent::PercentStyle &percentStyle)
{
