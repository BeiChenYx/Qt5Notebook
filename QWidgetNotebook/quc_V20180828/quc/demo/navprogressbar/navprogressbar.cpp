...
void NavProgressBar::setNavStyle(const NavProgressBar::NavStyle &navStyle)
{
...
void NavProgressBar::setBackground(const QColor &background)
{
...
void NavProgressBar::setForeground(const QColor &foreground)
{
...
void NavProgressBar::setCurrentBackground(const QColor &currentBackground)
{
...
void NavProgressBar::setCurrentForeground(const QColor &currentForeground)
{
