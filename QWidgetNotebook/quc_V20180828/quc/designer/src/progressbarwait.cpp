...
void ProgressBarWait::drawValue(QPainter *painter)
{
    if (!showPercent) {
        return;
    }
...
QColor ProgressBarWait::getTextColor() const
{
...
void ProgressBarWait::setBarStyle(const ProgressBarWait::BarStyle &barStyle)
{
...
void ProgressBarWait::setTextColor(const QColor &textColor)
{
