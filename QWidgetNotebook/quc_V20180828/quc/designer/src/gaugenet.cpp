...
void GaugeNet::drawValue(QPainter *painter)
{
    int radius = 100;
    painter->save();
...
void GaugeNet::setPointerStyle(const GaugeNet::PointerStyle &pointerStyle)
{
...
void GaugeNet::setScaleStyle(const GaugeNet::ScaleStyle &scaleStyle)
{
