...
void CDialog::initializePieSeries()
{
	...
	m_pieChart->setTitle("Pie Chart");

	m_pPieChartView = new QChartView(m_pieChart, tab_pie);
	...
	m_seriesPie->append("Jane", 1);
	m_seriesPie->append("Joe", 2);
	m_seriesPie->append("Andy", 3);
	m_seriesPie->append("Barbara", 4);
	m_seriesPie->append("Axel", 5);
	...
	QGridLayout* gridLaytoutPie = new QGridLayout(tab_pie);
