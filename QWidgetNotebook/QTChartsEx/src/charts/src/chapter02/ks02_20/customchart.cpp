...
//////////////////////////////////////////////////
CDrillDownChart::CDrillDownChart(QGraphicsItem *parent, Qt::WindowFlags wFlags)
...
CDrillDownChart::~CDrillDownChart()
{

}

void CDrillDownChart::changeSeries(QAbstractSeries *series)
{
	if (m_currentSeries)
...
void CDrillDownChart::handleSliceClicked(QPieSlice *slice)
{
	CDrilldownSlice *drilldownSlice = static_cast<CDrilldownSlice *>(slice);
